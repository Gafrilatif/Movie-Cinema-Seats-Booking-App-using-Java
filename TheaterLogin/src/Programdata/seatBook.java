...
public class seatBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        seat9.setBackground(new java.awt.Color(51, 255, 0));
        ...
        jLabel3.setText("STUDIO 1 : SPIDERMAN NO WAY HOME");
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon("C:\\Users\\farha\\Downloads\\poster-film-spider-man-no-way-home-the-more-fun-stuff-2.jpeg")); // NOI18N
        ...
        jLabel22.setText("*By clicking the \"Confirm\" button, you agree to the terms and conditions of this payment confirmation.");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(seatfield, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(0, 0, Short.MAX_VALUE)))
        ...
        try {
            switch (seatfield.getText()) {
                ...
                case "1":
                    ...
                    String saved = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "2":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved1 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "3":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved2 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "4":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved4 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "5":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved5 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "6":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved6 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "7":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved7 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "8":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved8 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "9":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved9 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "10":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved10 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "11":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved11 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                case "12":
                    ...
                    conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                    st = conn.createStatement();
                    String saved12 = "INSERT INTO seats (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
