...
public class seatBook3 extends javax.swing.JFrame {
    ...
    ResultSet rs = stmt.executeQuery("SELECT * FROM seats3");

    while (rs.next()) {
        // process each row of data
        String iBooked = rs.getString("is_booked");
        String seatNumb = rs.getString("seat_num");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("STUDIO 3 : FAST 9 SAGA");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\farha\\Downloads\\Ey8ZaOzUYAUxHUr1.jpg")); // NOI18N
        ...
        jLabel4.setText("*By clicking the \"Confirm\" button, you agree to the terms and conditions of this payment confirmation.");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(seatfield, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void butconfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butconfActionPerformed
        ...
        try {
            switch (seatfield.getText()) {
                ...
                String saved = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved1 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved2 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved4 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved5 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved6 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved7 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved8 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved9 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved10 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved11 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost/dblogin", "root", "");
                st = conn.createStatement();
                String saved12 = "INSERT INTO seats3 (seat_num, is_booked) VALUES ('" + seatfield.getText() + "', true)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seatBook3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
